...
#
# One-off coarse-mesh copy of examples/musgrave_vfsa_compare.jl. Uses the
# prior in tmp_musgrave_coarse/ and the same y_core_cell = 20000.0 mesh
# as examples/musgrave_real_data_coarse.jl. VFSA config is unchanged.
#
...
# 5-member ensemble already on disk (tmp_musgrave_coarse/prior/prior.rho).
...
#
# Run:  julia --project=. examples/musgrave_vfsa_compare_coarse.jl
#
...
isfile(PRIOR_RHO) || error("missing $PRIOR_RHO; run examples/musgrave_real_data_coarse.jl (5 members) first")
